...
/**
 * @typedef {Object} SoftAuroraProps
 ...
 * @property {number} [bandSpread]
 * @property {number} [octaveDecay]
 * @property {number} [layerOffset]
 * @property {number} [colorSpeed]
 * @property {boolean} [enableMouseInteraction]
